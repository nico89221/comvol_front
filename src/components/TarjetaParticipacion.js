                                    ...
                                    <div className="">
                                        {
                                            listIntegrantes.map(integrante => {
                                                return (
                                                    <div>
                                                        <a aria-label="Chat on WhatsApp" href={"whatsapp://send?phone=" + integrante.numeroCelular} target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faWhatsapp} style={{ color: "#37c011", paddingLeft: "10px" }} size="2x" /></a>
                                                    </div>
                                                )
                                            })
                                        }
