...
function TarjetaParticipacion(props) {
                                    ...
                                    <div className="">
                                        {
                                            listIntegrantes.map(integrante => {
                                                return (
                                                    <div>
                                                        <a aria-label="Chat on WhatsApp" href={"https://api.whatsapp.com/send/?phone=" + integrante.numeroCelular} target="_blank"><FontAwesomeIcon icon={faWhatsapp} style={{ color: "#37c011", paddingLeft: "10px" }} size="2x" /></a>
                                                    </div>
                                                )
                                            })
                                        }
    ...
    let whatsapp = "https://api.whatsapp.com/send/?phone=" + props.numeroCelularPropietario + "?text=Hola%20" + props.nombre + "%20te%20contacto%20desde%20la%20web%20de%20comvol%20por%20una%20postulacion%20tuya"
    return (
        ...
        <div class="card" style={{ width: "25rem", marginBottom:"12px" }}>
            ...
            <div class="card-body" style={{ paddingLeft:"55px",paddingRight:"2px",paddingBottom:"0px" }}>
                ...
                <div class="container-fechas">
                    ...
                    <a aria-label="Chat on WhatsApp" href={whatsapp} target="_blank"><FontAwesomeIcon icon={faWhatsapp} style={{ color: "#37c011", paddingLeft: "10px" }} size="2x" /></a>
                    </div>
                    <div class="wrap-fechas">
